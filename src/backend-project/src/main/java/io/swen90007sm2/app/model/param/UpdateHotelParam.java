...
public class UpdateHotelParam {

    @NotBlank(message = "target hotelId should not be null")
    ...
    public UpdateHotelParam(String name, String description, String address, String postCode, Boolean onSale, List<String> amenityIds) {
        this.name = name;
