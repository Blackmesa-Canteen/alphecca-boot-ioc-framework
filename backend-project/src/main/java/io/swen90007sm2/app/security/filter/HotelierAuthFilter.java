 ...
 */
@Filter(name = SecurityConstant.HOTELIER_ROLE_NAME)
public class HotelierAuthFilter extends AbstractAuthFilter {
    ...
    boolean performRoleAuthorization(AuthToken tokenBean) throws RequestException {
        ...
        if (!tokenBean.getRoleName().equals(filterAnno.name())) {
            ...
            throw new RequestException(
                    StatusCodeEnume.HOTELIER_AUTH_FAILED_EXCEPTION.getMessage(),
